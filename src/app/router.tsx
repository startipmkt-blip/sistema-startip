    ...
    children: [
      ...
      // Aplicação interna (equipe)
      {
        ...
        children: [
          ...
          { path: 'conteudo', element: <RequireModulo modulo="conteudo"><ConteudoPage /></RequireModulo> },
          ...
          { path: 'social-media', element: <RequireModulo modulo="social-media"><SocialMediaPage /></RequireModulo> },
