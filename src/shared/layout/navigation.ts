...
export const navItems: NavItem[] = [
  ...
  { label: 'Conteúdo', to: '/conteudo', icon: 'conteudo', comingSoon: false },
  ...
  { label: 'Social Media', to: '/social-media', icon: 'conteudo', comingSoon: false },
  ...
  { label: 'Meta Ads — Gestor', to: '/meta-ads', icon: 'financeiro', comingSoon: false, equipeOnly: true },
